...
class UserList extends React.Component {
    ...
    userLast=()=> {
        axios.get(`http://127.0.0.1:8000/api/getLast?user_id=66289`).then(resp => {
        ...
        //         axios.get('http://127.0.0.1:8000/api/users?integration_id=66289')
        //             .then(resp => {
                                ...
                                >
                                    ...
                                    <div className="chat_people"  >
                                        ...
                                        <div className="chat_img">
                                            <img src={ item.avatar ? `https://www.webwork-tracker.com/avatars/${item.avatar}` : defaultPng }  />
